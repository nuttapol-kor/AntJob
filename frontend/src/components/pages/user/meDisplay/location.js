...
const LocationTab = () => {
  ...
  // const headOfficeData = [{data: userProfile.headOffice.email, label: ""}]
        ...
        <Grid container spacing={2} style={{ marginBottom: 16 }}>
          <Grid item xs={12}>
            ...
            <Grid container spacing={1}>
              <Grid item><i class="fa-thin fa-location-dot"></i></Grid>
              <Grid item>
          ...
          <Grid item xs={12} sm={6}>
            ...
            <Grid container spacing={1}>
              <Grid item><i class="fa-thin fa-envelope"></i></Grid>
              <Grid item>
                <Grid container direction={"column"}>
                  <Grid item>{userProfile.headOffice.email}</Grid>
                  <Grid item>
          ...
          <Grid item xs={12} sm={6}>
            ...
            <Grid container spacing={1}>
              <Grid item><i class="fa-thin fa-mobile-screen-button"></i></Grid>
              <Grid item>
                <Grid container direction={"column"}>
